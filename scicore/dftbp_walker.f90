...
contains
  ...
  subroutine propagate(this, et, alat, deralat, thread_num)
    use mod_dftbp
    use parameters
    implicit none
    ...
    call energyandforces(nat, this%rxyz, fxyz, epot, alat, deralat, atomnames, thread_num)
    this%etot = epot
    !calculate the weights------------------------------------------------------
    this%weight = exp(-delta_t*(this%etot - et))
