program dmc
  ...
  call do_simulation(no_walkers_start, maxWalkers, delta_t, n_steps, damping)

  !print*, "Average E_0: ", sum(all_e0(50:n_steps))/(n_steps-50)

end program dmc

  subroutine do_simulation(no_walkers_start, maxWalkers, delta_t, n_steps, damping)
  use mod_dftbp
  use dftbp_walker
  use parameters
  implicit real(8) (a-h,o-z)
  ...
  do n=1,n_steps
    ...
    do j=1,no_walkers
      !move the walker
      call propagate(walkers(j), et, delta_t)
