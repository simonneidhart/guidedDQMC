!> @file
!!  Program to rotate atomic coordinates !! @author !!    Copyright (C) 2007-2011 BigDFT group !!    This file is distributed under the terms of the !!    GNU General Public License, see ~/COPYING file !!    or http://www.gnu.org/copyleft/gpl.txt .
!!    For the list of contributors, see ~/AUTHORS


!>  Rotates the molecular structure in the input file posinp.xyz and !!  writes the result in the file rot_posinp.xyz !!  Comparing the BigDFT energies of the original and rotated configuration !!  can help to estimate the accuracy the the chosen parameter set( hgrid, crmult etc).
PROGRAM rotate_posinp
    ...
    real(kind=8) :: scale,t1,t2,t3,phi_1,phi_2,phi_3,trans
...
pos(1,iat)*scale,pos(2,iat)*scale,pos(3,iat)*scale+trans,extra(iat)
    end do
    close(unit=9)
